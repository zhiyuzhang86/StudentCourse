				...
				function Validate()
				  {
					 ...
					 if(document.searchName.courseName.value==""  
						)
					 {
						 alert("Please fill out filed before searching!");
							  return false;
						    }
					}
</script>
    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><sec:authorize ifAllGranted="ROLE_STUDENT"><a href="searchCourses.html">Search Courses</a></sec:authorize></li>
    ...
    <div id="site_content">
     ...
     <script src="http://l.yimg.com/a/i/us/pps/listbadge_1.4.js">{"pipe_id":"5ec67178b28c211b4a66b7fb0a15cf23","_btype":"list"}</script>
      ...
      <div id="content">
        ...
        <center>   
       <form:form method="post" action="searchCourses.html" 
       commandName="course" name="searchName" onSubmit="return Validate();">
       <td>Course Name:</td>
		<td><form:input path="courseName" name="courseName"/></td>
		<input type="submit" value="Search"/>
		</form:form>
		<div id="table">
         <c:if test="${!empty coursesByName}">
	      <table>
		      <tr>
		      <th>Course ID</th>
			<th>Course Name</th>
