    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><sec:authorize ifAllGranted="ROLE_STUDENT"><a href="studentCourses.html">My Courses</a></sec:authorize></li>
      ...
      <div id="content">
        ...
        <div align="center" valign="middle">
         ...
         <c:forEach items="${coursesForStudent}" var="course">
			...
			<td><a href="dropCourse/${course.courseId}.html">drop</a></td>
		   </tr>
		</c:forEach>
	    </table>
         </c:if>
