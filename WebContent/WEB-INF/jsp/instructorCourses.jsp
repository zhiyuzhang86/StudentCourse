    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><sec:authorize ifAllGranted="ROLE_INSTRUCTOR"><a href="instructorCourses.html">My Courses</a></sec:authorize></li>
     ...
     <script src="http://l.yimg.com/a/i/us/pps/listbadge_1.4.js">{"pipe_id":"5ec67178b28c211b4a66b7fb0a15cf23","_btype":"list"}</script>
      ...
      <div id="content">
        ...
        <center>
         ...
         <c:if test="${!empty coursesForInstructor}">
	      <table>
		      <tr>
		      <th>Course ID</th>
			<th>Course Name</th>
